...
Resources that are similar or related or used as reference. Please update them when you find/use something so we can give credit where it's due and so others can learn!
